-- ~/.config/nvim/lua/tokyonight-custom.lua
require("tokyonight").setup({
	...
	on_highlights = function(highlights, colors)
		...
		-- Personalización de resaltados con colores naranjas y tema original
		highlights.Constant = { fg = colors.hint } -- Constantes en naranja
		highlights.String = { fg = colors.orange } -- Cadenas en naranja

		-- Mantener otros resaltados con el tema original
		highlights.Keyword = { fg = colors.fg }
